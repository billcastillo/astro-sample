...
export const SITE_DESCRIPTION =
  'Pinakamalakas na guild sa Ran Online Pinas. bagsakan ng mga pinakamatitikas at matatag na players. '
...
export const RAN_PINAS_SOCIAL = {
  bir_guild: {
    title: 'BIR Guild',
    type: 'facebook',
    url: 'https://www.facebook.com/profile.php?id=61558626726323',
  },
  ran_pinas: {
    title: 'RAN Online Pinas',
    type: 'facebook',
    url: 'https://www.facebook.com/ranonlinepinas',
  },
  ran_pinas_strife: {
    title: 'RAN Online Strife',
    type: 'facebook',
...
export const STREAMERS = [
  {
    name: 'ADOR',
    link: 'https://www.facebook.com/profile.php?id=100008440574329',
  },
]
